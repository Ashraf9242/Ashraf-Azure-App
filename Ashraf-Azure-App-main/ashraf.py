...
vision_data = {
    "vision_info": {
        ...
        "period": "2021-2040",
        "description": "رؤية طموحة تهدف إلى بناء مجتمع معرفي مستدام ومتنوع اقتصادياً، يقوده مواطنون معتزون بتراثهم وثقافتهم العمانية الأصيلة. تسعى الرؤية إلى تحقيق التنمية الشاملة والمستدامة التي تضمن رفاهية الأجيال القادمة."
    },
    "main_axes": [
        {
